...
class LanguageSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          AppColors.textcolor, // Deep burgundy background (#451425)
      body: Stack(
        children: [
              ...
              children: [
                ...
                Image.asset(
                  ...
                  errorBuilder: (context, error, stackTrace) => Column(
                    ...
                    children: [
                      Text('SFA', style: AppStyle.logoTitleLarge),
                      Text('SAUDI FASHION', style: AppStyle.logoSubtitleLarge),
                    ],
                  ),
                ),
                        ...
                        child: OutlinedButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('English', style: AppStyle.buttonTextLang),
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              const SizedBox(width: 4),
                              Text('العربية', style: AppStyle.buttonTextLang),
                              Transform.rotate(
                                angle: math.pi,
